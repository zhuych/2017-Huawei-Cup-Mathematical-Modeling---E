function time = strategy( position )
%  position第1-12个表示从D1出发的3A，3B，6C到的第一波发射节点编号，第13-24个表示从D2出发的3A，3B，6C到的第一波发射节点编号，第25-36个表示从D1出发的3A，3B，6C到的第二波发射节点编号，第37-48个表示从D2出发的3A，3B，6C到的第二波发射节点编号，属于[9，68]。
%读取坐标数据
